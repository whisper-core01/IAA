...
| --- | --- |
| Kernel | Stable, domain-agnostic semantic owner. |
| Organ | Replaceable capability admitted through a kernel contract. |
| Component | Replaceable technical or business specialization outside kernels. |
